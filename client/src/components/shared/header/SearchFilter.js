    ...
    <>
      ...
      >
        <div className="flex flex-col gap-y-4 h-full ">
          ...
          <div className="overflow-y-auto scrollbar-hide flex flex-col gap-y-4 h-full">
                  ...
                  <>
                    {filteredProducts?.map((product) => {
                      ...
                      return (
                        <div
                          key={product?._id}
                          className="flex flex-row gap-x-2 p-2 cursor-pointer border hover:border-black transition-colors rounded-lg"
                          onClick={() =>
                            router.push(
                              `/product?product_id=${
                                product?._id
                          ...
                          <article className="flex flex-col gap-y-2">
                            ...
                            <div className="flex flex-row justify-between gap-x-4 items-center">
                              ...
                              <div className="flex flex-row gap-x-1">
                                ...
                                <span className="whitespace-nowrap text-[10px] bg-blue-300/50 text-indigo-500 border border-blue-500 px-1.5 rounded">
