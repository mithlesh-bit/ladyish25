            ...
            <>
              ...
              >
                ...
                <article className="whitespace-normal">
                  ...
                  <p className="select-none text-xs">Register as a new user</p>
                </article>
              </Link> */}
              <Link
                href="/auth/signin"
              ...
              >
                ...
                <article className="whitespace-normal">
                  ...
                  <p className="select-none text-xs">Login to your account</p>
                </article>
              </Link>
              {/* <Link
              ...
              >
                ...
                <article className="whitespace-normal">
                  ...
                  <p className="select-none text-xs">Reset your account credentials</p>
                </article>
              </Link> */}
            </>
          ) : (
            <div className="flex flex-col gap-y-2">
              <div className="flex flex-row gap-x-2 p-4">
                ...
                <article className="flex flex-col text-start">
                  ...
                  <p className="select-none text-sm whitespace-nowrap overflow-hidden text-ellipsis">
                    {user?.email}
                  </p>

                  {/* <p className="select-none flex flex-row gap-x-2 mt-1.5">
              ...
              {/* <div className="w-full flex flex-row items-start gap-x-2 p-2 border border-transparent hover:border-black rounded cursor-pointer">
                ...
                >
                  ...
                  <p className="select-none text-xs">Clear your current activities</p>
                </article>
              </div> */}
            </div>
          )}
