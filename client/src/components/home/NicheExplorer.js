  ...
  return (
    <>
            ...
            {brands?.slice(0, 6)?.map((brand, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-y-2">
                  ...
                  <p className="select-none flex flex-row gap-x-1 items-center rounded-primary">
                    <BsBoxSeam />{" "}
                ...
                <p className="select-none flex flex-row gap-1 overflow-x-auto scrollbar-hide">
      ...
      {!fetchingBrands && brands?.length === 0 && (
        <p className="select-none text-sm">Oops! No brands found!</p>
      )}
        ...
        >
          <div className="h-full w-full flex flex-col gap-y-4">
            <div className="flex flex-col gap-y-1 items-center">
              ...
              <p className="select-none text-sm">{brand?.creator?.email}</p>
              {/* <p className="select-none text-xs">{brand?.creator?.phone}</p> */}
            </div>
                ...
                >
                  ...
                  >
                    ...
                    <article className="flex flex-col gap-y-1">
                      ...
                      <p className="select-none text-xs line-clamp-3">
                        By {product?.summary}
                      </p>
  ...
  return (
    <>
      ...
      {!fetchingCategories && categories?.length === 0 && (
        <p className="select-none text-sm">Oops! No categories found!</p>
      )}
        ...
        >
          <div className="h-full w-full flex flex-col gap-y-4">
            <div className="flex flex-col gap-y-1 items-center">
              ...
              />
              <h1 className="text-lg">{category?.title}</h1>
              {/* <p className="select-none text-sm">{category?.creator?.email}</p> */}
              {/* <p className="select-none text-xs">{category?.creator?.phone}</p> */}
            </div>
...
//         <p className="select-none text-sm">Oops! No stores found!</p>
//       )}
...
//               <p className="select-none text-sm">{store?.owner?.email}</p>
//               <p className="select-none text-xs">{store?.owner?.phone}</p>
//             </div>
