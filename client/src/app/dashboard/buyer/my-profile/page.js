  ...
  return (
    <Dashboard>
      <section className="flex flex-col gap-y-4">
        ...
        >
          {/* avatar */}
          <div className="flex flex-col justify-center items-center min-v-screen">
            {" "}
            {/* This will center the content vertically in a column */}
            <div className="w-fit flex flex-col justify-center gap-y-4 p-4 border rounded">
              <Image
      ...
      {isOpen && (
        ...
        >
          ...
          <article className="text-center">
            <p className="select-none mb-4">Are you sure you want to logout?</p>
