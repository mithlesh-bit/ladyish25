...
const Page = () => {
  const genAI = new GoogleGenerativeAI(
    "AIzaSyBqFPrC2-osiNR0OmRapk3W6hjrCtvnfHs"
  );
  ...
  function handleAddProduct(event) {
    ...
    formData.append("priceExtra", event.target.priceExtra.value);
      ...
      >
        ...
        <div className="w-full flex flex-col gap-y-4 p-4 border rounded">
          ...
          <label htmlFor="colors" className="w-full flex flex-col gap-y-1">
            ...
            {colors?.length === 0 ? (
              <p className="select-none text-sm">Loading...</p>
            ) : (
              <select
                name="colors"
                id="colors"
        ...
        <div className="w-full flex flex-col gap-y-4 p-4 border rounded">
          ...
          <label htmlFor="campaign" className="w-full flex flex-col gap-y-1">
            ...
            <p className="select-none flex flex-row gap-x-4">
              <input
                type="text"
                name="campaignTitle"
                id="campaignTitle"
          ...
          {/* price */}
          <label htmlFor="priceExtra" className="w-full flex flex-col gap-y-1">
            <span className="text-sm">Extra Price</span>
            <input type="number" name="priceExtra" id="priceExtra" />
          </label>
