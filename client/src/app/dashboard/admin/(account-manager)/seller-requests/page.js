...
const Page = () => {
  ...
  return (
    <Dashboard>
      {users?.length === 0 ? (
        <p className="select-none text-sm flex flex-row justify-center gap-x-2 items-center">
          ...
          {users?.map((user) => (
            ...
            >
              ...
              <div className="flex flex-col gap-y-0.5">
                ...
                <p className="select-none truncate text-sm">{user?.email}</p>
                <p className="select-none truncate text-xs">{user?.phone}</p>
              </div>
